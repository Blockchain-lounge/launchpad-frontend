import LinkIcon from "../../atoms/vectors/link-icon";
import SecureIcon from "../../atoms/vectors/secure-icon";
import GlobalIcon from "../../atoms/vectors/global-icon";
import "./display-wallet.scss";
import CloseIcon from "../../atoms/vectors/close-icon";

const DisplayWallet = ({ closeModal, setStage }) => {
